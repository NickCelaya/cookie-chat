angular.module('chatroom').service('messageService', function($http) {
    ...
    this.postMessage = function(key) {
        ...
        // return promise3.then(function(response) {
        //     console.log("workin");
        //     if (response.status === 200) {
        //         return response.data;
        //     }
        // })   I dont think I need this .then function becuase I'm using the POST method not GET method.
